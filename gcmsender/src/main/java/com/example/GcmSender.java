...
public class GcmSender {
    ...
    //public static final String API_KEY = "AIzaSyAJZEDudoyHH2fsJZYGz7c6jFS7G03Rx_c";
    public static final String API_KEY = "ENTER YOUR SERVER API KEY HERE";
